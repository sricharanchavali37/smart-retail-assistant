...
\[!\[Docker](https://img.shields.io/badge/Docker-sricharanchavali37%2Fsmart--retail--assistant-blue)](https://hub.docker.com/r/sricharanchavali37/smart-retail-assistant)



\## 🚀 Live API
https://smartretailapi.lemonmushroom-09a9d8f9.koreacentral.azurecontainerapps.io


Interactive Docs: \[/docs](https://smartretailapi.lemonmushroom-09a9d8f9.koreacentral.azurecontainerapps.io/docs)
...
└── Isolation Forest Anomaly Detection (53 anomalies)
...
├── Product Knowledge Agent — RAG over docs (FAISS)

└── Forecast Insight Agent  — ML + GPT-4o recommendations
...
├── Azure Blob Storage (bronze container)

├── Azure Data Factory (pipeline defined)
...
python backend/ml/run\_phase1.py
...
\- \*\*Azure Data Factory\*\* — Medallion pipeline (bronze→silver→gold)
...
\# 18 tests across ingest, predict, and agent endpoints
...
├── data/raw/            # Raw retail\_sales.csv
...
├── scripts/             # Azure Blob upload scripts
